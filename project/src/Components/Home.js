...
const Navigate = useNavigate()
  ...
  <div  className="mt-5">
    ...
    <Card  style={{marginTop:"4rem"}} className="bg-dark text-white ">
  ...
  <Card.ImgOverlay>
    ...
    <Button onClick={handleClick} style={{margin:"8rem auto auto  3rem", width:"15rem",height:"3.5rem"}} variant="outline-dark">Get Products</Button>
